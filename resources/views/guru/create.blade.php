...
@section('title', 'Halaman Tambah Data Guru')

@section('content')
<div class="content-row">
  <h2 class="content-row-title">Form Tambah Data Guru</h2>
  ...
  <hr>
    <div class="panel-body">
      ...
      <form role="form" action="{{ url('guru/tambah-guru/proses') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="nama_guru" class="form-control" id="nama_guru" placeholder="Masukan Nama">
